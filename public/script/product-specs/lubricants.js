...
<div class="row g-3 mb-2">
    ...
    <div class="col-md-6">
        <label>Oil Standard</label>
        <select name="oil_standard" class="form-select">
            <option value="">Select</option>
            <option value="API SJ">API SJ</option>
    ...
    <div class="col-md-6">
        ...
        <select name="coolant_type" class="form-select">
            ...
            <option value="Silicate-Free">Silicate-Free</option>
    ...
    <div class="col-md-6">
        ...
        <select name="transmission_oil_type" class="form-select">
            ...
            <option value="ATF Type F">ATF Type F</option>
            <option value="Other">Other</option>
        </select>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="other_fluids" class="form-control" placeholder="e.g. Fuel stabilizer, octane booster, oil additive">
    </div>
    <div class="col-md-6">
        <label>Quantity / Capacity</label>
        <input type="text" name="fluids_capacity" class="form-control" placeholder="Liters or ml (e.g. 1L, 500ml)">
    </div>
</div>
`;
