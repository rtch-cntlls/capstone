    ...
    <div class="d-flex">           
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="exportDropdown" style="font-size: 13px;">
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.inventory.export.all') }}">
                        <i class="fas fa-file-pdf text-danger me-2"></i> Export as PDF
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.inventory.export.csv') }}">
    ...
    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 g-3 p-2 mb-2">
        @foreach ($cards as $card)
            <div class="col">
                ...
                @endphp
                <a href="{{ route('admin.inventory.index', $statusParam ? ['status' => $statusParam] : []) }}" class="text-decoration-none">
