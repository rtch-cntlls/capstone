<div class="d-flex justify-content-between align-items-center p-2 mt-3">
    <h4 class="fw-bold m-0">Product Management</h4>
    <div class="d-flex">           
        <a href="{{ route('admin.product.create') }}" class="btn btn-primary">
            <i class="fa fa-plus me-2"></i> <span>Add new product</span>
        </a>
        <div class="dropdown ms-2">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="exportDropdown" style="font-size: 13px;">
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.product.export.pdf') }}">
                        <i class="fas fa-file-pdf text-danger me-2"></i> Export as PDF
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.product.export.csv') }}">
        ...
        @foreach ($cards as $card)
            <div class="col">
                @php
                    ...
                    $statusParam = strtolower($card['title']);
                    $cardLink = route('admin.product.index', ['status' => $statusParam]);
                @endphp
